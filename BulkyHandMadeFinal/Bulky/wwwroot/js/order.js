...
function loadDataTable(url) {
    dataTable = $('#tblData').DataTable({
        ...
        "columns": [
            ...
            { "data": "orderTotal", render: $.fn.dataTable.render.number( ',', '.', 2) , "width": "15%" },
            {
                "data": "id",
                "render": function (data) {
                    return `
                        <div class="text-center">
                        <a href="/Admin/Order/Details/${data}" class="btn btn-success text-white" style="cursor:pointer"><i class="fas fa-edit"></i></a>
                        </div>
                        `;
                }, "width": "5%"
            }
